...
urlpatterns = [
    ...
    path('index___leftside/', view=views.index___leftside, name='index___leftside'),
    ...
    #
    path('modules/', include('src.application.administration.modules.urls', namespace='modules')),
]
