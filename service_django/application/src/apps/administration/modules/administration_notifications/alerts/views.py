...
@decorators.security_user_has_permission(
    ...
    set_identifier___to_verify={'application_alerts_notification_list', }
)
def list(request):
...
@decorators.security_user_has_permission(
    ___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___ADMINISTRATION___,
    set_identifier___to_verify={'application_alerts_notification_list', 'application_alerts_notification_update', }
)
...
@decorators.security_user_has_permission(
    ___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___ADMINISTRATION___,
    set_identifier___to_verify={'application_alerts_notification_list', 'application_alerts_notification_create', }
)
def create(request):
...
@decorators.security_user_has_permission(
    ___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___ADMINISTRATION___,
    set_identifier___to_verify={'application_alerts_notification_list', 'application_alerts_notification_detail', }
)
...
@decorators.security_user_has_permission(
    ___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___ADMINISTRATION___,
    set_identifier___to_verify={'application_alerts_notification_list', 'application_alerts_notification_delete', }
)
