...
def index(request):
    ...
    return shortcuts.render(
        ...
        template_name='apps/notifications/application___notifications.html'
    )
...
def index___load(request):
    ...
    dict___data['___HTML___LOAD___'] = utils.___html___template___(
        request=request,
        context=dict(),
        template_name='apps/notifications/___includes___/load/load.html'
    )
...
def index___title(request):
    ...
    dict___data['___HTML___TITLE___'] = utils.___html___template___(
        request=request,
        context=dict(),
        template_name='apps/notifications/___includes___/title/title.html'
    )
    return http.JsonResponse(dict___data)
...
def index___header(request):
    ...
    dict___data['___HTML___HEADER___'] = utils.___html___template___(
        ...
        template_name='apps/notifications/___includes___/header/header.html'
    )
    return http.JsonResponse(dict___data)
...
def index___content___center(request):
    ...
    dict___data['___HTML___CONTENT___CENTER___'] = utils.___html___template___(
        ...
        template_name='apps/notifications/___includes___/content/center/index.html'
    )
    return http.JsonResponse(dict___data)
...
def index___content___footer(request):
    dict___data = dict()
    dict___data['___BOOLEAN___ERROR___'] = False
    dict___data['___HTML___NOTIFICATIONS___CONTENT___FOOTER___'] = utils.___html___template___(
        request=request,
        context=dict(),
        template_name='apps/notifications/___includes___/content/footer/footer.html'
    )
    return http.JsonResponse(dict___data)
...
def login(request):
    return utils_security.___jsonresponse___login___(
        request=request,
        ___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___NOTIFICATIONS___
    )
...
@decorators.ajax_required()
@decorators.required_security_user(___application___security___from___module___=utils_security.___APPLICATION___SECURITY___FROM___MODULE___NOTIFICATIONS___)
def logout(request):
