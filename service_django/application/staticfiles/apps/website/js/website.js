    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                $identifier.html(data.___HTML___CONTENT___CENTER___);
                $identifier.on("click", ".LINK___modal___reload", ___HTML___modal___RELOAD___);
            }
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                if (data.___HTML___MODAL___)
                    $("#site___modal").html(data.___HTML___MODAL___);
                if (data.___HTML___MODAL___MODAL___)
                    $("#site___modal").html(data.___HTML___MODAL___MODAL___);
            ...
            if (data.___BOOLEAN___ERROR___) {
                ...
                if (data.___BOOLEAN___IS_METHOD_POST___) {
                    if (data.___INT___IS_VALID_FORM___ == 1) {
                        ...
                        ___HTML___content___center___RELOAD___();
...
var ___HTML___modal___modal___RELOAD___ = function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        beforeSend: function () {
            $("#site___modal").addClass("application___website___invisible");
...
var ___HTML___modal___modal___ACTION_CLOSE___ = function () {
    ...
    $("#site___modal").removeClass("application___website___invisible");
};
