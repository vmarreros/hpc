...
var ___HTML___application___website___content___center___RELOAD___ = function (event) {
    var $identifier = $("#application___website___content___center");
    $.ajax({
        url: $identifier.attr("data-url"),
        type: "get",
        dataType: "json",
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                $identifier.html(data.___HTML___WEBSITE___CONTENT___CENTER___);
                $identifier.on("click", ".LINK___application___website___modal___reload", ___HTML___application___website___modal___RELOAD___);
            }
        }
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                $(identifier).html(data.___HTML___WEBSITE___CONTENT___FOOTER___);
            }
        }
    });
};
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                if (data.___HTML___APPLICATION___WEBSITE___MODAL___)
                    $("#application___website___modal").html(data.___HTML___APPLICATION___WEBSITE___MODAL___);
                if (data.___HTML___APPLICATION___WEBSITE___MODAL___MODAL___)
                    $("#application___website___modal").html(data.___HTML___APPLICATION___WEBSITE___MODAL___MODAL___);
            ...
            if (data.___BOOLEAN___ERROR___) {
                ...
                if (data.___BOOLEAN___IS_METHOD_POST___) {
                    if (data.___INT___IS_VALID_FORM___ == 1) {
                        ...
                        ___HTML___application___website___content___center___RELOAD___();
