!function (a, b, c) {
    ...
    var e = "application___notifications___leftside___nav", f = {toggle: !1, doubleTapToGo: !1};
    d.prototype = {
        init: function () {
...
var ___HTML___header___RELOAD___ = function () {
    var identifier = "#application___notifications___header";
    $.ajax({
        url: $(identifier).attr("data-url"),
        type: "get",
        dataType: "json",
...
var ___HTML___leftside___RELOAD___ = function () {
    var identifier_2 = "#application___notifications___content___center";
    $.ajax({
        ...
        success: function (data) {
            ...
            $(identifier_2).off("click", ".LINK___modal___reload");
            $(identifier_2).on("click", ".LINK___modal___reload", ___HTML___modal___RELOAD___);
        }
    });
};
/* */
var ___HTML___content___center___RELOAD___ = function (event) {
    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            $("#site___leftside.collapse").removeClass("in");
            $("#site___content___center").html(___HTML___LOAD___);
        },
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ___HTML___modal___SHOW_LOAD___();
                ___HTML___modal___SHOW_MESSAGE_ERROR___(data);
                $("#site___content___center").html("");
            }
            else {
                $("#site___content___center").html(data.___HTML___CONTENT___CENTER___);
            }
        }
    });
};
...
var ___HTML___content___footer___RELOAD___ = function () {
    var identifier = "#site___content___footer";
    $.ajax({
        url: $(identifier).attr("data-url"),
        type: "get",
        dataType: "json",
        ...
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ...
                $(identifier).html(data.___HTML___NOTIFICATIONS___CONTENT___FOOTER___);
            }
        }
    });
};
...
var ___HTML___modal___modal_content___SHOW_LOAD___ = function () {
    ...
    $identifier.html(___HTML___LOAD___);
    var int___height___application___notifications___load = $identifier.find(".application___notifications___load").height();
    int___height___application___notifications___load = (int___height___modal_content > int___height___application___notifications___load) ? int___height___modal_content : int___height___application___notifications___load;
    $identifier.find(".application___notifications___load").height(int___height___application___notifications___load);
};
var ___HTML___modal___modal_content___modal_body___SHOW_LOAD___ = function () {
    ...
    $identifier.html(___HTML___LOAD___);
    var int___height___application___notifications___load = $identifier.find(".application___notifications___load").height();
    int___height___application___notifications___load = (int___height___modal_body > int___height___application___notifications___load) ? int___height___modal_body : int___height___application___notifications___load;
    $identifier.find(".application___notifications___load").height(int___height___application___notifications___load);
};
var ___HTML___modal___modal_content___modal_body___SHOW_LOAD___SECURITY___LOGIN___ = function () {
    ...
    $identifier.html(___HTML___LOAD___);
    var int___height___application___notifications___load = $identifier.find(".application___notifications___load").height();
    int___height___application___notifications___load = (int___height___tab_pane_active___modal_body > int___height___application___notifications___load) ? int___height___tab_pane_active___modal_body : int___height___application___notifications___load;
    $identifier.find(".application___notifications___load").height(int___height___application___notifications___load);
};
...
var ___HTML___modal___modal___RELOAD___ = function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        beforeSend: function () {
            $("#site___modal").addClass("application___notifications___invisible");
...
var ___HTML___modal___modal___ACTION_CLOSE___ = function () {
    ...
    $("#site___modal").removeClass("application___notifications___invisible");
};
