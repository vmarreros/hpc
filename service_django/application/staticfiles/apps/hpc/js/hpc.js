...
var ___HTML___content___center___RELOAD___ = function (event) {
    ...
    searchRequest = $.ajax({
        ...
        beforeSend: function () {
            ...
            $("#application___hpc___leftside.collapse").removeClass("in");
            $("#application___hpc___content___center").html(___HTML___LOAD___);
        },
        success: function (data) {
            if (data.___BOOLEAN___ERROR___) {
                ___HTML___modal___SHOW_LOAD___();
                ...
                $("#application___hpc___content___center").on("click", ".LINK___modal___reload", ___HTML___modal___RELOAD___);
            }
        }
    });
};
...
var ___HTML___modal___SHOW_MESSAGE_ERROR___ = function (data, timeOut) {
    if(!timeOut)
        var timeOut = 3000;
    var $site___modal = $("#site___modal");
    $site___modal.html(data.___HTML___MODAL___);
...
var ___HTML___modal___modal___RELOAD___ = function () {
    ...
    $.ajax({
        ...
        dataType: "json",
        beforeSend: function () {
            $("#site___modal").addClass("application___hpc___invisible");
...
var ___HTML___modal___modal___ACTION_CLOSE___ = function () {
    ...
    $("#site___modal").removeClass("application___hpc___invisible");
};
